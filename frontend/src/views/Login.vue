                  ...
                  <form class="row g-3 needs-validation" novalidate @submit="login($event)">
                    ...
                    <div class="col-12">
                      ...
                      <!-- <div class="input-group has-validation">
                        ...
                        <input type="text" v-model="username" name="username" class="form-control" id="yourUsername" required autofocus>
                    ...
                    <div class="col-12">
                      <div class="form-check">
                        <input class="form-check-input" v-model="remember" type="checkbox" name="remember" value="true" id="rememberMe">
